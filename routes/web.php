...
Route::get('/questions/{question_id}/answer/{answer_id}/upvote', 'AnswerController@updateVotesIncrease')->name('answers.updateVotesIncrease');
Route::get('/questions/{question_id}/answer/{answer_id}/downvote', 'AnswerController@updateVotesDecrease')->name('answers.updateVotesDecrease');
